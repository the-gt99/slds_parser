...
async function setup(version = "1", implementation = vi.fn().mockResolvedValue({ externalId: "ext-1", operation: "created", metadata: {} })) {
  ...
  return { store, repositories, internal, implementation, runner: new ExportRunner(repositories, registry, new ReferenceMappingService(repositories.references)) };
}
