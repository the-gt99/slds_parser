...
export interface WordPressContentTemplateSelection {
  ...
  readonly templateSource?: string;
  readonly requireDescriptionAfterFallback?: boolean;
}
...
export function selectWordPressContentTemplate(
  ...
  const missingContextPaths = selected.requiredContextPaths.filter((path) => !(field === "description" && path === "content.story")
  ...
  return {
    ...
    requireDescriptionAfterFallback: selected.requiredContextPaths.includes("content.story"),
  };
}
