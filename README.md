...
2. `ProcessingRunner` преобразует сохранённые части в базовый `UniversalProductDTO` и последовательно применяет зарегистрированные операции.
